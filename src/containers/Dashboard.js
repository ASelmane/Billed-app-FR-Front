...
export default class {
    ...
    handleEditTicket(e, bill, bills) {
        console.log(this.id, bill.id, this.counter,e);
    ...
    handleShowTickets(e, bills, index) {
        //correction of the bug when the user click on the arrow
        if (this.counter === undefined || this.index !== index) {
            if(this.document.querySelectorAll("#status-bills-container" + index + " div").length === 0) {
                this.counter = 0;
            }
            else this.counter = 1;
        }
        ...
        //correction bug, multiple event on the same bill
